      ...
      binds =
        let
          ...
          wpctl = args: {
            ...
            action = actions.spawn ([ "wpctl" ] ++ args);
          };
          mouse = action: {
            cooldown-ms = 150;
            inherit action;
        ...
        in
        {
          ...
          "Mod+O".action = actions.spawn "handlr" "launch" "x-scheme-handler/https" "--";
          "Mod+N".action = actions.spawn "handlr" "launch" "inode/directory" "--";
